...
',
        ...
        $menu->services
            ->add(
                '<span>' .
                    ...
                    __('messages.service_request') .
                    '</span></span>',
                ['route' => 'service.provider-service-request'],
            )
            ->prepend(
                '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  <rect x="3" y="3" width="18" height="18" rx="2" stroke="currentColor" stroke-width="1.5"/>
  <line x1="6" y1="8" x2="18" y2="8" stroke="currentColor" stroke-width="1.5"/>
  ...
  <path d="M13 20L21 12L22 13L14 21H13V20Z" stroke="currentColor" stroke-width="1.5" fill="none"/>
  <path d="M22 13L21 14" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
</svg>',
            )
            ->data('permission', 'service list')
            ->link->attr(['class' => '']);
...
',
    ...
    $menu->add(
        '<span>' .
            __('messages.provider_promotional_banner') .
            '</span><span class="custom-tooltip"><span class="tooltip-text">' .
            __('messages.provider_promotional_banner') .
            '</span></span>',
    ...
    ->prepend(
        '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M7 5V19" stroke="currentColor" stroke-width="1.5"/>
            <path d="M17 5V19" stroke="currentColor" stroke-width="1.5"/>
